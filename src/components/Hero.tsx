...
export const Hero = () => {
  ...
  return <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-5 sm:pt-6">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 text-center py-[34px]">
        <motion.div initial={{
        opacity: 0,
        y: 20
      }} animate={{
        ...
        duration: 0.8
          ...
          <img src="/lovable-uploads/a707377f-d19b-40cc-a022-c7baa7bbced8.png" alt="ROJ Logo" className="w-24 h-24 sm:w-32 sm:h-32 mx-auto mb-4 sm:mb-8" />
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 px-2 sm:px-4">
            <Button onClick={handleMainButtonClick} className="bg-white/10 hover:bg-white/20 text-white px-4 sm:px-8 py-4 sm:py-6 text-base sm:text-lg rounded-full transition-all duration-300 border border-white/20 mb-3 sm:mb-0">
              {user ? <>
                  <Clock className="mr-2" size={20} />
                  Meditate & Accrue Points Now
                </> : "Sign In"}
            </Button>
            <Button onClick={handleFollow} className="bg-black/30 hover:bg-black/40 text-white px-4 sm:px-8 py-4 sm:py-6 text-base sm:text-lg rounded-full transition-all duration-300 border border-white/20 hover:border-white/40">
              <img src="/lovable-uploads/0b88d178-91da-4c76-9d67-7e294d0a1de6.png" alt="X Logo" className="w-4 h-4 sm:w-5 sm:h-5 mr-2 invert" /> 
