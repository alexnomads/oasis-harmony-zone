...
export const TokenBuyButton = () => {
  ...
  return <div className="flex justify-center items-center w-full">
      <button className="retro-button py-6 px-8 text-xl rounded-full glitch-text hover:opacity-90 transition-opacity" onClick={handleBuyClick} data-text="Buy $ROJ now on Pump Fun">
