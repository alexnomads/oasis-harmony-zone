  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <h2 className="text-xl sm:text-2xl font-bold text-accent mb-2">🌸 Global Wellness Stats</h2>
        <p className="text-sm text-muted-foreground">Community meditation and fitness progress</p>
      </div>
