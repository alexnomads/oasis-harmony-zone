-- Update the view to avoid using the security definer function
-- Instead we'll use a simple fallback approach for display names
...
SELECT 
    ...
    'user_' || substring(up.user_id::text from 1 for 8) as display_name
